...
`eval-personality` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/personality`)
...
- `direct_url`: `https://raw.githubusercontent.com/guiem/personality-tests/{SHA}/`
- `huggingface`: `mirlab/TRAIT`
