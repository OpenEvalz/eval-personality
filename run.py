#!/usr/bin/env python3
"""Run ONE problem of personality through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/personality_BFI"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one personality problem via TrustedRouter")
